...
- Current disposition from those benches:
  ...
  - decoder follow-up: new [decode_cputest_dat.py](/home/adam/030_mmu2/Minimig-AGA_MiSTer/tests/tg68k_030/decode_cputest_dat.py) walks the cumulative record/subcase structure directly. It identifies the photographed `JMP/0002` memwrite case as `record=37 group=1 subcase=0`, with cumulative `SRCADDR=$420069B0`, `D6=$00080808`, `A1=$8B`, and the expected `$008B/$008C` low-memory edits.
