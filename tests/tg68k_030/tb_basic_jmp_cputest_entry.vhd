...
begin
    ...
    test: process
        ...
        procedure run_variant(prefix : string;
                              use_65b2 : boolean) is
        begin
            check_trace_case(prefix & " user T1", x"8000", use_65b2);
            check_trace_case(prefix & " user T0", x"4000", use_65b2);
            check_trace_case(prefix & " user M1 T1", x"9000", use_65b2);
            check_trace_case(prefix & " user M1 T0", x"5000", use_65b2);
            check_trace_case(prefix & " supervisor T1", x"A000", use_65b2);
            check_trace_case(prefix & " supervisor T0", x"6000", use_65b2);
            check_trace_case(prefix & " supervisor M1 T1", x"B000", use_65b2);
            check_trace_case(prefix & " supervisor M1 T0", x"7000", use_65b2);
        end procedure;
    begin
