...
entity tb_pmove_readback_guard is
end entity;

architecture behavior of tb_pmove_readback_guard is
...
begin
    ...
    test: process
        ...
        begin
            ...
            mem(RESULT_ADDR / 2) := x"DEAD";
            mem(RESULT_ADDR / 2 + 1) := x"BEEF";
            mem(RESULT_ADDR / 2 + 2) := x"DEAD";
    ...
    begin
        report "=== PMOVE readback guard regression ===" severity note;
