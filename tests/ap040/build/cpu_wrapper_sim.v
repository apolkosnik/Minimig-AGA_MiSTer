...
// --- declarations hoisted for iverilog ---
wire        fill_req_c;
...
// hoisted: wire        fill_req_c;
// hoisted: wire [31:0] fill_addr_c;
// hoisted: wire        fill_instr_c;
// hoisted: wire        fill_cchip;
// hoisted: wire        fill_ok;
// hoisted: wire        fill_busy;
...
assign sel_dd = (cpu_addr[31:16] == 16'h00DD) && (cpu_addr[15:13] == 'b010); 
assign sel_rtg = (cpu_addr[31:24] == 8'h02); 

// don't sel_kickram when writing
assign sel_kickram = !cpu_addr[31:24] && (&cpu_addr[23:19] || (cpu_addr[23:19] == 5'b11100)) && ckick && wr; // $f8xxxx, e0xxxx
assign sel_kicklower = !cpu_addr[31:24] && (cpu_addr[23:18] == 6'b111110); 
assign sel_chipram = !cpu_addr[31:21] && cchip; //$000000 - $1FFFFF
...
// hoisted: reg  [31:0] cpu_addr;
// hoisted: reg  [15:0] cpu_dout;
assign cpu_din = ramsel ? ramdat : fastchip_selack ? fastchip_dout : {sel_autoconfig ? autocfg_data : chip_data[15:12], chip_data[11:0]}; 
// hoisted: reg         wr;
// hoisted: reg         uds_in;
// hoisted: reg         lds_in;
// hoisted: reg  [15:0] chip_data;
// hoisted: reg  [31:0] vbr;
...
// hoisted: wire [15:0] cpu_dout_p;
// hoisted: wire [31:0] cpu_addr_p;
// hoisted: wire  [1:0] cpustate_p;
// hoisted: wire [31:0] cacr_p;
// hoisted: wire [31:0] vbr_p;
// hoisted: wire        wr_p;
// hoisted: wire        uds_p;
// hoisted: wire        lds_p;
// hoisted: wire        reset_out_p;
// hoisted: wire        longword;
// hoisted: wire        walker_req_p, walker_we_p;
// hoisted: wire [31:0] walker_addr_p, walker_wdat_p;
// hoisted: wire        cache_maint_p;
// hoisted: reg         cache_maint_d;
// hoisted: reg         cache_clear_toggle;
// hoisted: wire        bus_berr;
assign bus_complete = chipready | ramready | fastchip_ready; 
...
// hoisted: reg  [2:0] snoop_tgl_s;
// hoisted: reg        snoop_stb_r;
// hoisted: reg [31:0] snoop_addr_r;
always @(posedge clk) begin
	if (!reset) begin
		snoop_tgl_s <= 0;
		snoop_stb_r <= 0;
...
// hoisted: reg turbochip_d;
// hoisted: reg turbokick_d;
// hoisted: reg dcache_d;
always @(posedge clk) begin
...
// hoisted: reg [2:0] cpu_ipl = 3'b111;
always @(posedge clk) begin
	chipreq <= cpu_req & ~ramsel & ~fastchip_selack;
	cpu_ipl <= ipl_i;
end

// hoisted: reg ph1n, ph2n;
always @(posedge clk) begin
	ph1n <= ph1;
	ph2n <= ph2;
end

// hoisted: reg        chipready;
// hoisted: reg [15:0] chipdout_i;
// hoisted: reg  [2:0] ipl_i = 3'b111;   // idle, see cpu_ipl
// hoisted: reg        c_as,c_rw,c_uds,c_lds;
...
// hoisted: reg       ac_toccata;
// hoisted: reg       ac_a2065;
// hoisted: reg [2:0] ac_memcard;
// hoisted: reg [3:0] autocfg_data;
...
assign sel_autoconfig = (chip_addr[23:16] == 8'b11101000) && (ac_memcard || ac_toccata || ac_a2065); //$E80000 - $E8FFFF

// hoisted: reg       z2ram_ena;
// hoisted: reg [4:0] z3ram_base0;
// hoisted: reg [3:0] z3ram_base1;
// hoisted: reg       z3ram_ena0;
// hoisted: reg       z3ram_ena1;
always @(posedge clk) begin
	reg old_uds;
	old_uds <= chip_uds;
