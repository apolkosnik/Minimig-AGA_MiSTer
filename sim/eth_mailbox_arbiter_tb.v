...
//   eth_ddr3_mailbox  (clk_sys 16-bit eth_dma  ->  clk_avl 64-bit Avalon)
//   eth_avalon_arbiter (m0 = ddr_svc burst reads, m1 = mailbox, shared slave)
//
// Checks:
