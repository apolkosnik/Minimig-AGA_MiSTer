...
begin
    ...
    hazard_detect: process(id_ea_valid, id_ea_src_reg1, id_ea_src_reg2,
                          ...
                          of_ex_valid, of_ex_dst_reg, of_ex_write,
    ...
    begin
        ...
        -- For Phase 4, we handle all hazards with forwarding, no stalls needed
        -- (Load-use hazards will require stalls in Phase 5)
        hazard_out.stall_required := '0';
