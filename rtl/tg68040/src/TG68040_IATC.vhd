...
------------------------------------------------------------------------------
--                                                                          --
-- TG68040 Instruction Address Translation Cache (I-ATC) - Phase 9         --
--                                                                          --
-- Wrapper around generic ATC specialized for instruction addresses        --
--                                                                          --
...
--
-- Instruction ATC:
-- - Wraps generic ATC for instruction address translation
-- - Integrated with I-Cache for coordinated operation
...
entity TG68040_IATC is
    port(
        ...
        -- Translation request (from IF stage)
...
architecture stub of TG68040_IATC is
