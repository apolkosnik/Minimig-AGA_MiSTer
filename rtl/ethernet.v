...
parameter [31:0] ETH_SHM_NE_MEMORY     = 32'h00003000;  // 16KB - NE2000 memory space
parameter [31:0] ETH_SHM_DEBUG_INFO    = 32'h00007000;  // 8KB - debug info
...
assign is_data_port_access = (byte_addr == 16'h0640) || (byte_addr == 16'h0c40);

// NE2000 memory range 0x3000-0x6FFF (16KB memory window)
// Direct memory access to system memory at eth_shared_base + ETH_SHM_OFFSET _ ETH_SHM_NE_MEMORY
assign is_memory_access = (byte_addr >= 16'h3000) && (byte_addr <= 16'h7FFF);
...
assign is_control_access = (byte_addr >= 16'h1000) && (byte_addr <= 16'h1FFF); // Disabled - system memory handles this
...
assign is_buffer_access = (byte_addr >= 16'h2000) && (byte_addr <= 16'h2FF); // Disabled - system memory handles this
